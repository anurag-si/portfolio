...
import { BriefcaseIcon, CameraIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 flex items-center justify-center px-6">
      <div className="max-w-4xl w-full text-center">
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-16 font-normal">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-2xl mx-auto">
          ...
          <Link
            href="/work"
            className="group relative bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200 hover:border-blue-500 transition-all duration-300 hover:shadow-2xl hover:scale-105"
          >
            <div className="flex flex-col items-center">
              <div className="p-4 bg-blue-100 rounded-full mb-4 group-hover:bg-blue-500 transition-colors">
                <BriefcaseIcon className="h-12 w-12 text-blue-600 group-hover:text-white transition-colors" />
              </div>
          ...
          <Link
            href="/personal"
            className="group relative bg-white rounded-2xl p-8 shadow-lg border-2 border-gray-200 hover:border-indigo-500 transition-all duration-300 hover:shadow-2xl hover:scale-105"
          >
            <div className="flex flex-col items-center">
              <div className="p-4 bg-indigo-100 rounded-full mb-4 group-hover:bg-indigo-500 transition-colors">
                <CameraIcon className="h-12 w-12 text-indigo-600 group-hover:text-white transition-colors" />
              </div>
